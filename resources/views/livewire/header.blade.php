<nav class="bg-black">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        ...
                        <a href="/actualites" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-sans titleHeaderClass"
    ...
    <div class="sm:hidden" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="/actualites" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-sans titleHeaderClass"
               aria-current="page">ACTUALITÉS</a>
